...
export function App() {
  ...
  // ФИКС: Обединяваме метаданните със свързването на аудиото
  const onLoadedMetadata = useCallback(() => {
    if (handleLoadedMetadata) handleLoadedMetadata();
    if (audioRef.current && connectAudioElement) {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col font-sans selection:bg-purple-500/30">
      <main className="flex-1 flex flex-col lg:flex-row p-4 lg:p-8 gap-8 max-w-7xl mx-auto w-full overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className={`p-2 rounded-full transition-all ${showEqualizer ? 'bg-purple-600 text-white shadow-lg' : 'hover:bg-gray-800 text-gray-400'}`}
              >
        ...
        {/* ДЯСНА СТРАНА: Качване и Плейлист (Оригинална визия) */}
